...
for d in docs:
    ...
    new_img = None
    if name == 'Modern English School Cairo':
        new_img = 'assets/images/Modern_English_School_Cairo.jpg'
    elif name == 'Continental School of Cairo':
        new_img = 'assets/images/Continental_School_of_Cairo.jpg'
    
    if new_img:
        print(f"Updating {name} in DB -> {new_img}")
